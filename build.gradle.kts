...
val generateApiSpec = tasks.register("generateApiSpec",GenerateTask::class){
    ...
    setProperty("apiPackage", "$group.api.spec")
    setProperty("invokerPackage", "$group.api.invoker")
    setProperty("modelPackage", "$group.api.model")
...
val generateApiClient = tasks.register("generateApiClient",GenerateTask::class){
    ...
    setProperty("packageName", "$group.test.client")
